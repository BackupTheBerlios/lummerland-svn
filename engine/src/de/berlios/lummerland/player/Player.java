...
public class Player implements ICertificateHolder {
     ...
     *            color
     */
    public Player(Engine game, Color color) {
        this.game = game;
        this.color = color;
        game.addPlayer(this);
    }
     ...
     * @param adapter
     */
    public void addSpecificStockListener(de.berlios.lummerland.stock.ISpecificStockListener l) {
        specificStockListeners.add(l);
    }

    public void removeSpecificStockListener(de.berlios.lummerland.stock.ISpecificStockListener l) {
