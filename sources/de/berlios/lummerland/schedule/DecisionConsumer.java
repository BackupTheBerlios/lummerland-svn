...
public abstract class DecisionConsumer extends ScheduleItem {
	 ...
	 * @param game, parent
	 */
	public DecisionConsumer(Game game, String name, ScheduleComposite parent) {
	 ...
	 * Method executeBody.
	 */
	protected final void executeBody() {
	 ...
	 */
	protected abstract void consumeDecision(Decision d);
}
