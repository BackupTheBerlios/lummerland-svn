...
public final class DummyScheduleItem extends ScheduleItem {
     ...
     * @param parent
     */
    public DummyScheduleItem(Engine game, String name, ScheduleComposite parent) {
     ...
     * 
     * @param executeGameState
     *            The executeGameState to set
     */
     ...
     * 
     * @param executeVisited
     *            The executeVisited to set
     */
